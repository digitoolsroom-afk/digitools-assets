    ...
    if (typeof window.triggerCreateCourse === 'function') {
      window.triggerCreateCourse(
        ...
        async function(course) {
          ...
          // ── Passe à l'étape 2 ──
          // Option A — redirect Webflow (décommenter + adapter l'URL) :
          // window.location.href = '/espace-freelance/creation-formation-contenu';

          // Option B — scroll vers l'embed étape 2 si sur la même page :
